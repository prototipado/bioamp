/*
 * @brief Biopotenciales LIRINS - board file
 *
 * @note
...
/** @defgroup BOARD "Biopoteciales-LIRINS" - board software API functions
 * @ingroup LPCOPEN_17XX_BOARD_BiopotecialesLIRINS
...
/** BOARD_NXP_LPCXPRESSO_1769_OPTIONS BOARD: NXP LPC1769 LPCXpresso board build options
