/*
 * @brief Biopotenciales LIRINS -Sysinit file
 *
 * @note
...
//TODO: "Biopotenciales LIRINS" project pin muxing
STATIC const PINMUX_GRP_T pinmuxing[] = {
	...
	//	{2, 8, IOCON_MODE_PULLUP | IOCON_FUNC0},
		...
		/*Additional Configurations supported by the "Biopotenciales-LIRINS" board */
